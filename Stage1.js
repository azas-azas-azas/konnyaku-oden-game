export class Stage1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.infoText = this.add.text(
            20,
            20,
            '目指せコンニャク！[←][↑][→][↓]キーでコンニャクイモを操作して、障害物を避けながら地上を目指そう！',
    ...
    update(time, delta) {
        ...
        // Player hitbox (compute once per frame)
    ...
    onHitEnemy() {
        ...
        this.infoText.setText('虫やモグラに当たった… もう一度挑戦！');
    ...
    onReachGoal() {
        ...
        this.infoText.setText('畑を脱出！ 次は工場へ…（あとでStage2に進む処理を入れる）');

        this.time.delayedCall(2000, () => {
            this.scene.restart(); // 後で Stage2 に切り替えに変更
        });
    }
